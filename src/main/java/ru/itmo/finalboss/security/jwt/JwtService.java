...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, Long userId) {
        return Jwts
                ...
                // токен валидный 1 сутки, тут можно поигратсья
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        return (userId.equals(getUserIdFromUserDetails(userDetails)) && !isTokenExpired(token));
    }

    private String getUserIdFromUserDetails(UserDetails userDetails) {
        return ((UserEntity) userDetails).getId().toString();
    }
